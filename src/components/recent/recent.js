...
const Recent = () => {
  ...
  const iconState = localStorage.getItem("FavHeartID")
            ...
            <div className="favColumnReverse">
              {" "}
                {recentSearchData.map((searchData, i) => {
                  let farToCel = (((searchData.current_observation.condition
                    .temperature - 32) * 5) / 9).toFixed(0)
                  switch (
                  searchData &&
                  ...
                  <div className="favBodyContainer" key={i}>
                    <div className="favBody">
                      ...
                      <div className="fillHeart">
                        ...
                        {
                          iconState &&
                          iconState.includes(searchData.location.woeid) ?
                            <img
                            ...
                            <img
                              ...
                              alt=""
                              className="fillHeartImg whiteheart"
                            />
                        }
